...
def api():
    ...
    if(b['bank'] == "BANK SYARIAH INDONESIA "):
        ...
        if (d == "Transfer Bank" or d == "Transfer Antar"):
            ...
            roi = [
                [(5, (11 + 23)), (82, 640), 'keterangan_tf', 'text'],
            ...
            roi = [
                ...
                [(181, (186 + 26)), (170, 640), 'danaorder_id_tp', 'text'],
                [(283, (288 + 26)), (168, 640), 'pembelian_tp', 'text'],
                [(317, (322 + 26)), (239, 640), 'no_hp', 'text'],
                [(385, (390 + 26)), (168, 640), 'nama_pelanggan_tp', 'text'],
            ...
            roi = [
                ...
                [(95, (100 + 28)), (206, 640), 'tgl', 'tanggal'],
                [(156, (161 + 23)), (155, 640), 'danaorder_id_tp', 'text'],
            ...
            roi = [
                ...
                [(155, (160 + 24)), (154, 560), 'danaorder_id_tp', 'text'],
