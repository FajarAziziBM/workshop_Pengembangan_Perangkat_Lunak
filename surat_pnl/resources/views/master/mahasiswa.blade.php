...
<div class="container-fluid py-3">
    <nav aria-label="breadcrumb">
        ...
        <h2 class="font-weight-bolder mb-3">Akun</h2>
    </nav>

    <ul class="nav nav-tabs mt-7 ms-4">
        <li class="nav-item">
            <a class="nav-link {{ Request::is('dosen') ? 'active' : '' }} fs-4" aria-current="page" href="/master-data/dosen">Dosen</a>
        </li>
        <li class="nav-item">
            <a class="nav-link {{ Request::is('mahasiswa') ? 'active' : '' }} fs-4" href="/master-data/mahasiswa">Mahasiswa</a>
        </li>
        <a class="nav-link {{ Request::is('mahasiswa') ? 'active fw-semibold' : '' }} fs-4" href="/master-data/approvesior">Approvesior</a>
    </ul>

    <h3 class="main-title mt-2 fw-bold mt-6 ms-5">Data Mahasiswa</h3>
