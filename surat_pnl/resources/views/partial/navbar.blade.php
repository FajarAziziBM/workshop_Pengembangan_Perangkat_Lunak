        ...
        <ul class="nav navbar-nav align-items-center ml-auto">
            ...
            <li class="nav-item nav-search">
                <a class="nav-link nav-link-search">
                    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-search ficon">
            ...
            <li class="nav-item dropdown dropdown-user">
                <a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" href="javascript:void(0);" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <div class="user-nav d-sm-flex d-none">
                        ...
                        <span class="user-name font-weight-bolder">Super Admin</span>
                    </div>
                    <span class="avatar">
                        <img class="round" src="http://emagang.pnl.ac.id/webmagang-images/blank.png" alt="avatar" height="40" width="40">
                ...
                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdown-user">
                    ...
                    <a class="dropdown-item" href="http://emagang.pnl.ac.id/logout" onclick="event.preventDefault();document.getElementById('logout-form').submit();">
