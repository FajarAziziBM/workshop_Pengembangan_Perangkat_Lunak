        ...
        <form action="">
            ...
            <div class="mb-3">
              ...
              <div class="mb-3">
                ...
                <input type="password" class="form-control border ps-3" id="password">
              </div>
              <button type="submit" class="btn btn-primary float-end ms-2">Simpan</button>
              <button type="submit" class="btn btn-primary float-end">Batal</button>
        </form>
    </div>
</div>
@endsection
