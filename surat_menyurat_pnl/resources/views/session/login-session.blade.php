...
<main class="main-content  mt-0">
  <section>
    <div class="page-header min-vh-75">
      <div class="container">
        <div class="row">
          <div class="col-xl-6 col-lg-5 col-md-5 d-flex flex-column mx-auto">
            <div class="card card-plain mt-8">
              <div class="card-header pb-0 text-left bg-transparent">
                <h2 class="font-weight-bolder text-info text-gradient">Welcome Us</h2>
              </div>
              <div class="card-body">
                <form role="form" method="POST" action="/session">
                  ...
                  <label>ID</label>
                  <div class="mb-3">
                    <input type="email" class="form-control" name="email" id="email" placeholder="Email" value="BomanCode@gmail.com" aria-label="Email" aria-describedby="email-addon">
                    @error('email')
          ...
          <div class="col-md-6">
            <div class="oblique position-absolute top-35 h-100 d-md-block d-none me-n5">
